...
private:
    // data handles (owned)
        // _image: avatar image, make shared since chatbot is copieable
...
public:
    ...
    // Delete copy constrctor not needed
    ...
    wxBitmap *GetImageHandle() { return(_image.get() == nullptr ? NULL :  _image.get());}
